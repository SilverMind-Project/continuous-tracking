...
class SceneSample(_message.Message):
    __slots__ = ("keyframe_id", "tracklet_id", "global_track_id", "camera_id", "minio_key", "captured_at_unix_ns", "tag_reason", "annotations_json", "expires_at_unix_ns")
    ...
    def __init__(self, keyframe_id: _Optional[str] = ..., tracklet_id: _Optional[str] = ..., global_track_id: _Optional[str] = ..., camera_id: _Optional[str] = ..., minio_key: _Optional[str] = ..., captured_at_unix_ns: _Optional[int] = ..., tag_reason: _Optional[_Union[TagReason, str]] = ..., annotations_json: _Optional[str] = ..., expires_at_unix_ns: _Optional[int] = ...) -> None: ...
