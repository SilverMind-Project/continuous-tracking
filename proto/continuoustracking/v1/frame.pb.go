...
// 	protoc        v5.29.3
// source: proto/continuoustracking/v1/frame.proto
...
func (x *FrameReady) Reset() {
	*x = FrameReady{}
	mi := &file_proto_continuoustracking_v1_frame_proto_msgTypes[0]
...
func (*FrameReady) Descriptor() ([]byte, []int) {
	return file_proto_continuoustracking_v1_frame_proto_rawDescGZIP(), []int{0}
}
...
func (x *FrameResponse) Reset() {
	*x = FrameResponse{}
	mi := &file_proto_continuoustracking_v1_frame_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FrameResponse) Descriptor() ([]byte, []int) {
	return file_proto_continuoustracking_v1_frame_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_continuoustracking_v1_frame_proto protoreflect.FileDescriptor

const file_proto_continuoustracking_v1_frame_proto_rawDesc = "" +
	"\n" +
	"'proto/continuoustracking/v1/frame.proto\x12\x15continuoustracking.v1\"\x98\x02\n" +
	"\n" +
	"FrameReady\x12\x1b\n" +
...
var (
	file_proto_continuoustracking_v1_frame_proto_rawDescOnce sync.Once
	file_proto_continuoustracking_v1_frame_proto_rawDescData []byte
)

func file_proto_continuoustracking_v1_frame_proto_rawDescGZIP() []byte {
	file_proto_continuoustracking_v1_frame_proto_rawDescOnce.Do(func() {
		file_proto_continuoustracking_v1_frame_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_continuoustracking_v1_frame_proto_rawDesc), len(file_proto_continuoustracking_v1_frame_proto_rawDesc)))
	})
	return file_proto_continuoustracking_v1_frame_proto_rawDescData
}

var file_proto_continuoustracking_v1_frame_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_continuoustracking_v1_frame_proto_goTypes = []any{
	(*FrameReady)(nil),    // 0: continuoustracking.v1.FrameReady
	(*FrameResponse)(nil), // 1: continuoustracking.v1.FrameResponse
}
var file_proto_continuoustracking_v1_frame_proto_depIdxs = []int32{
...
func init() { file_proto_continuoustracking_v1_frame_proto_init() }
func file_proto_continuoustracking_v1_frame_proto_init() {
	if File_proto_continuoustracking_v1_frame_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_continuoustracking_v1_frame_proto_rawDesc), len(file_proto_continuoustracking_v1_frame_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_continuoustracking_v1_frame_proto_goTypes,
		DependencyIndexes: file_proto_continuoustracking_v1_frame_proto_depIdxs,
		MessageInfos:      file_proto_continuoustracking_v1_frame_proto_msgTypes,
	}.Build()
	File_proto_continuoustracking_v1_frame_proto = out.File
	file_proto_continuoustracking_v1_frame_proto_goTypes = nil
	file_proto_continuoustracking_v1_frame_proto_depIdxs = nil
}
